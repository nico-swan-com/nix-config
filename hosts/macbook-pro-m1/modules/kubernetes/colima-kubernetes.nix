...
let
  cfg = config.services.colima-kubernetes;
in
{
  options.services.colima-kubernetes = {
    enable = mkEnableOption "Colima with Kubernetes";
    ...
    package = mkPackageOption pkgs "colima-kubernetes" { };
  ...
  config = mkIf cfg.enable rec {
    ...
    launchd.daemons.colima-kubernetes =
      let
